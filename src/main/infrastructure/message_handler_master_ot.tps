create or replace type message_handler_master_ot as object(
/*******************************************************************************
 Master object type for chain of responsibility pattern applied to message 
...
*******************************************************************************/
  threshold     number
--------------------------------------------------------------------------------
 ,not final not instantiable member procedure handle(
     p_level   in  number
   , p_message in  varchar2
   )
--------------------------------------------------------------------------------
,not final not instantiable member procedure process_request(p_message in varchar2)
)
not final
not instantiable
/
